...
| --------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| MC-001    | desktop の macro/combo list、または mobile の選択メニューで item、設定、`Create macro` / `New combo` を選ぶ | 直後の編集 pane は macro、combo、各 Global Settings のいずれか一つ。別 domain の選択は解除される。mobile menu は Macros / Combos / Settings に分かれ、項目の未保存・変更済み dot を維持する | 選択だけでは書込まない                                                                                                                                      | S1/S4/S5                                                                                                  |
...
6. mobile の選択メニューが Refresh/Reset/Save と同じ行に収まり、長い名前を切り詰め、選択後に閉じて直下の編集 pane を表示するか。`Unsaved changes` の文字は隠れても status dot と各 menu item の dot が残るか。
