...
const ja: Record<string, string> = {
  ...
  "Example input peak before scaling": "スケーリング前の想定入力の最大値",
  "Example input": "想定入力",
  ...
  "A parabolic input peaks at 3.2 seconds and stops abruptly at 5 seconds (20 ms reports). The example amplitude adapts to scaling and thresholds, capped at 32767 raw counts. Output trends average physical input plus supplemental inertia over 200 ms. Inertia fills the gap between retained speed and the latest physical input rate. Both modes are previewed as enabled. When Fast input is OFF, its preview threshold is ceil(max(input threshold × 1.5, 20)), capped at 65535. Curves can coincide at 100% boost or when the Fast threshold is not reached. Output may continue beyond 15 seconds.":
    "入力は3.2秒で頂点になる放物線で、5秒で途中停止します（20ms周期）。想定入力の大きさはスケーリングとしきい値に合わせ、最大32767に調整します。出力線は実入力と補助慣性出力の合計を200ms区間で平均しています。慣性は保持した速度と直近の実入力速度の不足分を補います。両モードをONとして比較します。Fast inputがOFFの場合、プレビューのしきい値はmax(入力閾値×1.5,20)を切上げ、65535以内にします。倍率100%やFastしきい値に届かない場合は線が重なります。15秒以降も出力が続く場合があります。",
  ...
  "Keymap settings": "キーマップ設定",
  "Layer editing": "レイヤー編集",
  "Current layer": "現在のレイヤー",
  "Layer actions": "レイヤー操作",
  "Layout and display": "配列と表示",
  ...
  "No available combo slots.": "空きコンボスロットがありません。",
  ...
  Queued: "待機中",
  "Memory...": "メモリに書き込み中...",
  "Waiting to apply...": "反映待機中...",
  "Applying to memory...": "メモリに反映中...",
  ...
  param2: "param2",
  "Key to press": "押すキー",
  "Layer active while held": "長押し中のレイヤー",
  "Layer to switch to": "切り替え先のレイヤー",
  "Layer to toggle": "切り替えるレイヤー",
  "Key sent on tap": "タップ時のキー",
  "Key to toggle": "切り替えるキー",
...
const zh: Record<string, string> = {
  ...
  "Example input peak before scaling": "缩放前的示例输入峰值",
  "Example input": "示例输入",
  "Inertia output": "普通惯性：总输出",
  "Fast input output": "Fast input：总输出",
  "A parabolic input peaks at 3.2 seconds and stops abruptly at 5 seconds (20 ms reports). The example amplitude adapts to scaling and thresholds, capped at 32767 raw counts. Output trends average physical input plus supplemental inertia over 200 ms. Inertia fills the gap between retained speed and the latest physical input rate. Both modes are previewed as enabled. When Fast input is OFF, its preview threshold is ceil(max(input threshold × 1.5, 20)), capped at 65535. Curves can coincide at 100% boost or when the Fast threshold is not reached. Output may continue beyond 15 seconds.":
    "抛物线输入在3.2秒达到峰值，并在5秒突然停止（20ms周期）。示例输入幅度按缩放和阈值调整，上限32767。输出趋势为实际输入和补充惯性输出之和的200ms区间平均值。惯性补足保持速度与最新实际输入速度之间的差。预览假定两种模式开启。Fast input关闭时，预览阈值为ceil(max(输入阈值×1.5,20))，上限65535。倍率100%或未达到Fast阈值时曲线可重合。输出可能在15秒后继续。",
  ...
  "Layer {{id}}": "层 {{id}}",
  "Keymap layers": "键位层",
  "Keymap settings": "键位设置",
  "Layer editing": "层编辑",
  "Current layer": "当前层",
  "Layer actions": "层操作",
  "Layout and display": "布局与显示",
  "Stream mode": "流模式",
  ...
  "No available combo slots.": "没有可用的组合键插槽。",
  ...
  Queued: "排队中",
  "Memory...": "正在写入内存...",
  "Waiting to apply...": "等待应用...",
  "Applying to memory...": "正在应用到内存...",
  ...
  param2: "参数2",
  "Key to press": "要按下的按键",
  "Layer active while held": "按住时激活的层",
  "Layer to switch to": "要切换到的层",
  "Layer to toggle": "要切换的层",
  "Key sent on tap": "轻触时发送的按键",
  "Key to toggle": "要切换的按键",
